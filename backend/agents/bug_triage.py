...
pr_drafter_agent = LlmAgent(
    ...
    instruction="""You have an approved bug fix. Create a PR immediately.
    Use create_pull_request_direct with:
    - repo: the repository name from context
    - title: "fix: automated bug fix by RepoVision AI"  
    - body: "Automated fix generated by RepoVision AI agents"
    Do not ask for input. Call the tool immediately and output JSON:
    {"pr_url": str, "bug_fixed": str}""",
