...
root_agent = LlmAgent(
    ...
    - Run all 3 tools: pr_reviewer_module, bug_triage_module, repo_health_module
    ...
    - Run ONLY pr_reviewer_module

    When given just a repo for health check:
    - Run ONLY repo_health_module
